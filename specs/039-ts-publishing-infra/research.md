...
- **npmjs.com**: The public registry. Rejected because it requires separate authentication tokens
  and account management, increasing friction for a specification project.
