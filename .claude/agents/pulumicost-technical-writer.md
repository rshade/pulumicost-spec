...
When starting work in any repository, first output a "Content Status" assessment identifying
documentation gaps, outdated sections, and missing examples. Then proceed with creating or
updating the requested documentation following these standards.
