...
const (
	...
	CostSourceServiceName = "finfocus.v1.CostSourceService"
	// ObservabilityServiceName is the fully-qualified name of the ObservabilityService service.
	ObservabilityServiceName = "finfocus.v1.ObservabilityService"
)
...
const (
	...
	CostSourceServiceNameProcedure = "/finfocus.v1.CostSourceService/Name"
	// CostSourceServiceSupportsProcedure is the fully-qualified name of the CostSourceService's
	// Supports RPC.
	CostSourceServiceSupportsProcedure = "/finfocus.v1.CostSourceService/Supports"
	...
	// GetPricingSpec RPC.
	CostSourceServiceGetPricingSpecProcedure = "/finfocus.v1.CostSourceService/GetPricingSpec"
	// CostSourceServiceEstimateCostProcedure is the fully-qualified name of the CostSourceService's
	// EstimateCost RPC.
	CostSourceServiceEstimateCostProcedure = "/finfocus.v1.CostSourceService/EstimateCost"
	...
	CostSourceServiceGetRecommendationsProcedure = "/finfocus.v1.CostSourceService/GetRecommendations"
	...
	// GetPluginInfo RPC.
	CostSourceServiceGetPluginInfoProcedure = "/finfocus.v1.CostSourceService/GetPluginInfo"
	...
	// GetMetrics RPC.
	ObservabilityServiceGetMetricsProcedure = "/finfocus.v1.ObservabilityService/GetMetrics"
	...
	ObservabilityServiceGetServiceLevelIndicatorsProcedure = "/finfocus.v1.ObservabilityService/GetServiceLevelIndicators"
)

// CostSourceServiceClient is a client for the finfocus.v1.CostSourceService service.
...
// Supports calls finfocus.v1.CostSourceService.Supports.
...
// GetActualCost calls finfocus.v1.CostSourceService.GetActualCost.
...
// GetPricingSpec calls finfocus.v1.CostSourceService.GetPricingSpec.
...
// EstimateCost calls finfocus.v1.CostSourceService.EstimateCost.
...
// GetRecommendations calls finfocus.v1.CostSourceService.GetRecommendations.
...
// DismissRecommendation calls finfocus.v1.CostSourceService.DismissRecommendation.
...
// GetPluginInfo calls finfocus.v1.CostSourceService.GetPluginInfo.
...
func (UnimplementedCostSourceServiceHandler) Name(context.Context, *connect.Request[v1.NameRequest]) (*connect.Response[v1.NameResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.CostSourceService.Name is not implemented"))
}
...
func (UnimplementedCostSourceServiceHandler) Supports(context.Context, *connect.Request[v1.SupportsRequest]) (*connect.Response[v1.SupportsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.CostSourceService.Supports is not implemented"))
}
...
func (UnimplementedCostSourceServiceHandler) GetPricingSpec(context.Context, *connect.Request[v1.GetPricingSpecRequest]) (*connect.Response[v1.GetPricingSpecResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.CostSourceService.GetPricingSpec is not implemented"))
}
...
func (UnimplementedCostSourceServiceHandler) EstimateCost(context.Context, *connect.Request[v1.EstimateCostRequest]) (*connect.Response[v1.EstimateCostResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.CostSourceService.EstimateCost is not implemented"))
}
...
func (UnimplementedCostSourceServiceHandler) GetRecommendations(context.Context, *connect.Request[v1.GetRecommendationsRequest]) (*connect.Response[v1.GetRecommendationsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.CostSourceService.GetRecommendations is not implemented"))
}
...
func (UnimplementedCostSourceServiceHandler) GetPluginInfo(context.Context, *connect.Request[v1.GetPluginInfoRequest]) (*connect.Response[v1.GetPluginInfoResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.CostSourceService.GetPluginInfo is not implemented"))
}
...
// NewObservabilityServiceClient constructs a client for the finfocus.v1.ObservabilityService
...
func NewObservabilityServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ObservabilityServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	observabilityServiceMethods := v1.File_finfocus_v1_costsource_proto.Services().ByName("ObservabilityService").Methods()
...
// HealthCheck calls finfocus.v1.ObservabilityService.HealthCheck.
...
// GetMetrics calls finfocus.v1.ObservabilityService.GetMetrics.
...
// GetServiceLevelIndicators calls finfocus.v1.ObservabilityService.GetServiceLevelIndicators.
...
// ObservabilityServiceHandler is an implementation of the finfocus.v1.ObservabilityService service.
...
func NewObservabilityServiceHandler(svc ObservabilityServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/finfocus.v1.ObservabilityService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedObservabilityServiceHandler) HealthCheck(context.Context, *connect.Request[v1.HealthCheckRequest]) (*connect.Response[v1.HealthCheckResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.ObservabilityService.HealthCheck is not implemented"))
}
...
func (UnimplementedObservabilityServiceHandler) GetMetrics(context.Context, *connect.Request[v1.GetMetricsRequest]) (*connect.Response[v1.GetMetricsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.ObservabilityService.GetMetrics is not implemented"))
}
...
func (UnimplementedObservabilityServiceHandler) GetServiceLevelIndicators(context.Context, *connect.Request[v1.GetServiceLevelIndicatorsRequest]) (*connect.Response[v1.GetServiceLevelIndicatorsResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("finfocus.v1.ObservabilityService.GetServiceLevelIndicators is not implemented"))
}
