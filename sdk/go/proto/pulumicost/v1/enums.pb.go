...
const file_pulumicost_v1_enums_proto_rawDesc = "" +
	"
" +
	"pulumicost/v1/enums.protopulumicost.v1*¼
" +
	"FocusServiceCategory&
" +
	"\"FOCUS_SERVICE_CATEGORY_UNSPECIFIED \"
" +
	"FOCUS_SERVICE_CATEGORY_COMPUTE\"
" +
	"FOCUS_SERVICE_CATEGORY_STORAGE\"
" +
	"FOCUS_SERVICE_CATEGORY_NETWORK#
" +
	"FOCUS_SERVICE_CATEGORY_DATABASE$
" +
	" FOCUS_SERVICE_CATEGORY_ANALYTICS+
" +
	"'FOCUS_SERVICE_CATEGORY_MACHINE_LEARNING%
" +
	"!FOCUS_SERVICE_CATEGORY_MANAGEMENT#
" +
	"FOCUS_SERVICE_CATEGORY_SECURITY*
" +
	"&FOCUS_SERVICE_CATEGORY_DEVELOPER_TOOLS	 
" +
	"FOCUS_SERVICE_CATEGORY_OTHER
" +
	"*Š
" +
	"FocusChargeCategory%
" +
	"!FOCUS_CHARGE_CATEGORY_UNSPECIFIED 
" +
	"FOCUS_CHARGE_CATEGORY_USAGE\"
" +
	"FOCUS_CHARGE_CATEGORY_PURCHASE 
" +
	"FOCUS_CHARGE_CATEGORY_CREDIT
" +
	"FOCUS_CHARGE_CATEGORY_TAX 
" +
	"FOCUS_CHARGE_CATEGORY_REFUND$
" +
	" FOCUS_CHARGE_CATEGORY_ADJUSTMENT*Ï
" +
	"FocusPricingCategory&
" +
	"\"FOCUS_PRICING_CATEGORY_UNSPECIFIED #
" +
	"FOCUS_PRICING_CATEGORY_STANDARD$
" +
	" FOCUS_PRICING_CATEGORY_COMMITTED\"
" +
	"FOCUS_PRICING_CATEGORY_DYNAMIC 
" +
	"FOCUS_PRICING_CATEGORY_OTHER*y
" +
	"FocusChargeClass\"
" +
	"FOCUS_CHARGE_CLASS_UNSPECIFIED 
" +
	"FOCUS_CHARGE_CLASS_REGULAR!
" +
	"FOCUS_CHARGE_CLASS_CORRECTION*±
" +
	"FocusChargeFrequency&
" +
	"\"FOCUS_CHARGE_FREQUENCY_UNSPECIFIED #
" +
	"FOCUS_CHARGE_FREQUENCY_ONE_TIME$
" +
	" FOCUS_CHARGE_FREQUENCY_RECURRING&
" +
	"\"FOCUS_CHARGE_FREQUENCY_USAGE_BASED*±
" +
	"FocusCommitmentDiscountCategory2
" +
	".FOCUS_COMMITMENT_DISCOUNT_CATEGORY_UNSPECIFIED ,
" +
	"(FOCUS_COMMITMENT_DISCOUNT_CATEGORY_SPEND,
" +
	"(FOCUS_COMMITMENT_DISCOUNT_CATEGORY_USAGE*©
" +
	"FocusCommitmentDiscountStatus0
" +
	",FOCUS_COMMITMENT_DISCOUNT_STATUS_UNSPECIFIED )
" +
	"%FOCUS_COMMITMENT_DISCOUNT_STATUS_USED+
" +
	"'FOCUS_COMMITMENT_DISCOUNT_STATUS_UNUSED*­
" +
	"FocusCapacityReservationStatus1
" +
	"-FOCUS_CAPACITY_RESERVATION_STATUS_UNSPECIFIED *
" +
	"&FOCUS_CAPACITY_RESERVATION_STATUS_USED,
" +
	"(FOCUS_CAPACITY_RESERVATION_STATUS_UNUSED*Ì
" +
	"FieldSupportStatus$
" +
	" FIELD_SUPPORT_STATUS_UNSPECIFIED \"
" +
	"FIELD_SUPPORT_STATUS_SUPPORTED$
" +
	" FIELD_SUPPORT_STATUS_UNSUPPORTED$
" +
	" FIELD_SUPPORT_STATUS_CONDITIONAL 
" +
	"FIELD_SUPPORT_STATUS_DYNAMIC*t
" +
	"
" +
	"GrowthType
" +
	"GROWTH_TYPE_UNSPECIFIED 
" +
	"GROWTH_TYPE_NONE
" +
	"GROWTH_TYPE_LINEAR
" +
	"GROWTH_TYPE_EXPONENTIALBBZ@github.com/rshade/pulumicost-spec/sdk/go/proto/pulumicost/v1;pbcbproto3"
