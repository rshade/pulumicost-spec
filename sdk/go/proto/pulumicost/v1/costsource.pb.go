...
type RecommendationFilter struct {
	...
	// upgrades (t2â†’t3) or Graviton migrations (m5â†’m6g).
...
const file_pulumicost_v1_costsource_proto_rawDesc = "" +
	"
" +
	"pulumicost/v1/costsource.protopulumicost.v1google/protobuf/timestamp.protogoogle/protobuf/struct.protopulumicost/v1/focus.protopulumicost/v1/budget.protopulumicost/v1/enums.proto\"
" +
	"NameRequest\"\"
" +
	"NameResponse
...
" +
	"ImpactMetric-
" +
	"kind (2.pulumicost.v1.MetricKindRkind
" +
	"value (Rvalue
" +
	"unit (	Runit\"P
" +
	"SupportsRequest=
" +
	"resource (2!.pulumicost.v1.ResourceDescriptorRresource\"¨
" +
	"SupportsResponse
" +
...
" +
	"reason (	RreasonU
" +
	"capabilities (21.pulumicost.v1.SupportsResponse.CapabilitiesEntryRcapabilitiesF
" +
	"supported_metrics (2.pulumicost.v1.MetricKindRsupportedMetrics?
" +
	"CapabilitiesEntry
" +
	"key (	Rkey
...
" +
	"end (2.google.protobuf.TimestampRendA
" +
	"tags (2-.pulumicost.v1.GetActualCostRequest.TagsEntryRtags
" +
	"arn (	Rarn
" +
	"dry_run (RdryRun7
...
" +
	"value (	Rvalue:8\"Ù
" +
	"GetActualCostResponse9
" +
	"results (2.pulumicost.v1.ActualCostResultRresults@
" +
	"fallback_hint (2.pulumicost.v1.FallbackHintRfallbackHintC
" +
	"dry_run_result (2.pulumicost.v1.DryRunResponseRdryRunResult\"š
" +
	"GetProjectedCostRequest=
" +
	"resource (2!.pulumicost.v1.ResourceDescriptorRresource5
" +
	"utilization_percentage (RutilizationPercentage:
" +
	"growth_type (2.pulumicost.v1.GrowthTypeR
" +
	"growthType$
" +
	"growth_rate (H R
...
" +
	"currency (	Rcurrency$
" +
	"cost_per_month (RcostPerMonth%
" +
	"billing_detail (	RbillingDetailB
" +
	"impact_metrics (2.pulumicost.v1.ImpactMetricRimpactMetrics:
" +
	"growth_type (2.pulumicost.v1.GrowthTypeR
" +
	"growthTypeC
" +
	"dry_run_result (2.pulumicost.v1.DryRunResponseRdryRunResult\"V
" +
	"GetPricingSpecRequest=
" +
	"resource (2!.pulumicost.v1.ResourceDescriptorRresource\"H
" +
	"GetPricingSpecResponse.
" +
	"spec (2.pulumicost.v1.PricingSpecRspec\"ä
" +
	"ResourceDescriptor
" +
	"provider (	Rprovider#
...
" +
	"region (	Rregion?
" +
	"tags (2+.pulumicost.v1.ResourceDescriptor.TagsEntryRtags:
" +
	"utilization_percentage (H RutilizationPercentageˆ
" +
	"id (	Rid
" +
	"arn (	Rarn:
...
" +
	"source (	RsourceA
" +
	"focus_record (2.pulumicost.v1.FocusCostRecordRfocusRecordB
" +
	"impact_metrics (2.pulumicost.v1.ImpactMetricRimpactMetrics\"=
" +
	"UsageMetricHint
...
" +
	"metric_hints	 (2.pulumicost.v1.UsageMetricHintRmetricHintsW
" +
	"plugin_metadata
" +
	" (2..pulumicost.v1.PricingSpec.PluginMetadataEntryRpluginMetadata
" +
	"source (	Rsource
" +
	"unit (	Runit 
" +
	"assumptions (	Rassumptions?
" +
	"pricing_tiers (2.pulumicost.v1.PricingTierRpricingTiersA
" +
	"PluginMetadataEntry
" +
	"key (	Rkey
...
" +
	"ErrorDetail,
" +
	"code (2.pulumicost.v1.ErrorCodeRcode8
" +
	"category (2.pulumicost.v1.ErrorCategoryRcategory
" +
	"message (	RmessageA
" +
	"details (2'.pulumicost.v1.ErrorDetail.DetailsEntryRdetails3
" +
	"retry_after_seconds (H RretryAfterSecondsˆ8
" +
	"	timestamp (2.google.protobuf.TimestampR	timestamp:
" +
	"DetailsEntry
...
" +
	"status (2).pulumicost.v1.HealthCheckResponse.StatusRstatus
" +
	"message (	RmessageB
" +
	"last_check_time (2.google.protobuf.TimestampRlastCheckTime\"h
" +
	"Status
" +
	"STATUS_UNSPECIFIED 
...
" +
	"STATUS_NOT_SERVING
" +
	"STATUS_SERVICE_UNKNOWN\"N
" +
	"GetMetricsRequest!
" +
	"metric_names (	RmetricNames
" +
	"format (	Rformat\"—
" +
	"GetMetricsResponse/
" +
	"metrics (2.pulumicost.v1.MetricRmetrics8
" +
	"	timestamp (2.google.protobuf.TimestampR	timestamp
" +
	"format (	Rformat\"–
...
" +
	"help (	Rhelp-
" +
	"type (2.pulumicost.v1.MetricTypeRtype5
" +
	"samples (2.pulumicost.v1.MetricSampleRsamples\"Ú
" +
	"MetricSample?
" +
	"labels (2'.pulumicost.v1.MetricSample.LabelsEntryRlabels
" +
	"value (Rvalue8
" +
...
" +
	"value (	Rvalue:8\"x
" +
	" GetServiceLevelIndicatorsRequest7
" +
	"
" +
	"time_range (2.pulumicost.v1.TimeRangeR	timeRange
" +
	"	sli_names (	RsliNames\"¤
" +
	"!GetServiceLevelIndicatorsResponse8
" +
	"slis (2$.pulumicost.v1.ServiceLevelIndicatorRslisE
" +
	"measurement_time (2.google.protobuf.TimestampRmeasurementTime\"Ì
" +
...
" +
	"status (2.pulumicost.v1.SLIStatusRstatus\"k
" +
	"	TimeRange0
" +
	"start (2.google.protobuf.TimestampRstart,
...
" +
	"span_id (	RspanId;
" +
	"fields (2#.pulumicost.v1.LogEntry.FieldsEntryRfields@
" +
	"error_details (2.pulumicost.v1.ErrorDetailsRerrorDetails9
" +
	"FieldsEntry
" +
	"key (	Rkey
...
" +
	"EstimateCostRequest#
" +
	"resource_type (	RresourceType7
" +
	"
" +
...
" +
	"currency (	Rcurrency!
" +
	"cost_monthly (RcostMonthly\"Ï
" +
	"GetRecommendationsRequest;
" +
	"filter (2#.pulumicost.v1.RecommendationFilterRfilter+
" +
	"projection_period (	RprojectionPeriod
" +
...
" +
	"excluded_recommendation_ids (	RexcludedRecommendationIdsL
" +
	"target_resources (2!.pulumicost.v1.ResourceDescriptorRtargetResources\"Í
" +
	"GetRecommendationsResponseG
" +
	"recommendations (2.pulumicost.v1.RecommendationRrecommendations>
" +
	"summary (2$.pulumicost.v1.RecommendationSummaryRsummary&
" +
	"next_page_token (	RnextPageToken\"¤
" +
...
" +
	"region (	Rregion#
" +
	"resource_type (	RresourceTypeA
" +
	"category (2%.pulumicost.v1.RecommendationCategoryRcategoryH
" +
	"action_type (2'.pulumicost.v1.RecommendationActionTypeR
" +
	"actionType
" +
	"sku (	RskuA
" +
	"tags (2-.pulumicost.v1.RecommendationFilter.TagsEntryRtagsA
" +
	"priority (2%.pulumicost.v1.RecommendationPriorityRpriority2
" +
	"min_estimated_savings	 (RminEstimatedSavings
" +
	"source
" +
	" (	Rsource
...
" +
	"sort_by (2#.pulumicost.v1.RecommendationSortByRsortBy7
" +
	"
" +
	"sort_order (2.pulumicost.v1.SortOrderR	sortOrder0
" +
	"min_confidence_score (RminConfidenceScore 
" +
	"max_age_days (R
" +
	"maxAgeDays
...
" +
	"actionTypeE
" +
	"resource (2).pulumicost.v1.ResourceRecommendationInfoRresource>
" +
	"	rightsize (2.pulumicost.v1.RightsizeActionH R	rightsize>
" +
	"	terminate (2.pulumicost.v1.TerminateActionH R	terminateA
" +
	"
" +
	"commitment (2.pulumicost.v1.CommitmentActionH R
" +
	"commitmentA
" +
	"
" +
	"kubernetes (2.pulumicost.v1.KubernetesActionH R
" +
	"kubernetes5
" +
	"modify	 (2.pulumicost.v1.ModifyActionH Rmodify;
" +
	"impact
" +
	" (2#.pulumicost.v1.RecommendationImpactRimpactA
" +
	"priority (2%.pulumicost.v1.RecommendationPriorityRpriority.
" +
	"confidence_score (HRconfidenceScoreˆ 
" +
	"description (	Rdescription
" +
...
" +
	"
" +
	"created_at (2.google.protobuf.TimestampHR	createdAtˆG
" +
	"metadata (2+.pulumicost.v1.Recommendation.MetadataEntryRmetadata;
" +
	"MetadataEntry
" +
	"key (	Rkey
...
" +
	"sku (	RskuG
" +
	"tags (23.pulumicost.v1.ResourceRecommendationInfo.TagsEntryRtagsD
" +
	"utilization (2\".pulumicost.v1.ResourceUtilizationRutilization7
" +
	"	TagsEntry
" +
	"key (	Rkey
...
" +
	"memory_percent (RmemoryPercent'
" +
	"storage_percent (RstoragePercent&
" +
	"network_in_mbps (RnetworkInMbps(
" +
	"network_out_mbps (RnetworkOutMbps\
" +
	"custom_metrics (25.pulumicost.v1.ResourceUtilization.CustomMetricsEntryRcustomMetrics@
" +
	"CustomMetricsEntry
" +
	"key (	Rkey
...
" +
	"currentSku'
" +
	"recommended_sku (	RrecommendedSku2
" +
	"current_instance_type (	RcurrentInstanceType:
" +
	"recommended_instance_type (	RrecommendedInstanceTypeW
" +
	"projected_utilization (2\".pulumicost.v1.ResourceUtilizationRprojectedUtilization\"]
" +
	"TerminateAction-
" +
...
" +
	"controller_kind (	RcontrollerKind'
" +
	"controller_name (	RcontrollerName%
" +
	"container_name (	RcontainerNameM
" +
	"current_requests (2\".pulumicost.v1.KubernetesResourcesRcurrentRequestsU
" +
	"recommended_requests (2\".pulumicost.v1.KubernetesResourcesRrecommendedRequestsI
" +
	"current_limits (2\".pulumicost.v1.KubernetesResourcesRcurrentLimitsQ
" +
	"recommended_limits	 (2\".pulumicost.v1.KubernetesResourcesRrecommendedLimits
" +
	"	algorithm
" +
	" (	R	algorithm\"?
...
" +
	"ModifyAction+
" +
	"modification_type (	RmodificationTypeU
" +
	"current_config (2..pulumicost.v1.ModifyAction.CurrentConfigEntryRcurrentConfiga
" +
	"recommended_config (22.pulumicost.v1.ModifyAction.RecommendedConfigEntryRrecommendedConfig@
" +
	"CurrentConfigEntry
" +
	"key (	Rkey
...
" +
	"projected_cost (RprojectedCost-
" +
	"savings_percentage (RsavingsPercentage4
" +
	"implementation_cost (H RimplementationCostˆ9
" +
	"migration_effort_hours (HRmigrationEffortHoursˆB
" +
	"_implementation_costB
" +
	"_migration_effort_hours\"›
" +
	"RecommendationSummary3
" +
	"total_recommendations (RtotalRecommendations6
" +
	"total_estimated_savings (RtotalEstimatedSavings
" +
	"currency (	Rcurrency+
" +
	"projection_period (	RprojectionPeriode
" +
	"count_by_category (29.pulumicost.v1.RecommendationSummary.CountByCategoryEntryRcountByCategoryk
" +
	"savings_by_category (2;.pulumicost.v1.RecommendationSummary.SavingsByCategoryEntryRsavingsByCategoryl
" +
	"count_by_action_type (2;.pulumicost.v1.RecommendationSummary.CountByActionTypeEntryRcountByActionTyper
" +
	"savings_by_action_type (2=.pulumicost.v1.RecommendationSummary.SavingsByActionTypeEntryRsavingsByActionTypeB
" +
	"CountByCategoryEntry
" +
	"key (	Rkey
" +
	"value (Rvalue:8D
" +
	"SavingsByCategoryEntry
" +
	"key (	Rkey
" +
	"value (Rvalue:8D
" +
	"CountByActionTypeEntry
" +
	"key (	Rkey
" +
	"value (Rvalue:8F
" +
	"SavingsByActionTypeEntry
" +
	"key (	Rkey
" +
	"value (Rvalue:8\"š
...
" +
	"recommendation_id (	RrecommendationId6
" +
	"reason (2.pulumicost.v1.DismissalReasonRreason#
" +
	"custom_reason (	RcustomReason>
" +
	"
" +
	"expires_at (2.google.protobuf.TimestampH R	expiresAtˆ!
" +
	"dismissed_by (	RdismissedByB
" +
	"_expires_at\"Ž
" +
...
" +
	"message (	Rmessage=
" +
	"dismissed_at (2.google.protobuf.TimestampRdismissedAt>
" +
	"
" +
	"expires_at (2.google.protobuf.TimestampH R	expiresAtˆ+
" +
	"recommendation_id (	RrecommendationIdB
" +
	"_expires_at\"
" +
...
" +
	"	providers (	R	providersN
" +
	"metadata (22.pulumicost.v1.GetPluginInfoResponse.MetadataEntryRmetadata;
" +
	"MetadataEntry
" +
	"key (	Rkey
...
" +
	"
" +
	"field_name (	R	fieldNameH
" +
	"support_status (2!.pulumicost.v1.FieldSupportStatusRsupportStatus3
" +
...
" +
	"DryRunRequest=
" +
	"resource (2!.pulumicost.v1.ResourceDescriptorRresourcek
" +
	"simulation_parameters (26.pulumicost.v1.DryRunRequest.SimulationParametersEntryRsimulationParametersG
" +
	"SimulationParametersEntry
" +
	"key (	Rkey
" +
	"value (	Rvalue:8\"ð
" +
	"DryRunResponseB
" +
	"field_mappings (2.pulumicost.v1.FieldMappingRfieldMappings/
" +
	"configuration_valid (RconfigurationValid1
" +
	"configuration_errors (	RconfigurationErrors6
" +
	"resource_type_supported (RresourceTypeSupported*Œ
" +
	"
" +
	"MetricKind
...
" +
	"METRIC_KIND_ENERGY_CONSUMPTION
" +
	"METRIC_KIND_WATER_USAGE*€
" +
	"FallbackHint
" +
	"FALLBACK_HINT_UNSPECIFIED 
" +
	"FALLBACK_HINT_NONE
" +
...
" +
	"ERROR_CODE_INVALID_PROVIDER$
" +
	" ERROR_CODE_PLUGIN_NOT_CONFIGURED*
" +
	"
" +
	"MetricType
...
" +
	"METRIC_TYPE_SUMMARY*w
" +
	"	SLIStatus
" +
	"SLI_STATUS_UNSPECIFIED 
" +
	"SLI_STATUS_MEETING_TARGET
" +
	"SLI_STATUS_WARNING
" +
	"SLI_STATUS_CRITICAL*Û
" +
	"RecommendationCategory'
" +
	"#RECOMMENDATION_CATEGORY_UNSPECIFIED  
" +
	"RECOMMENDATION_CATEGORY_COST'
" +
	"#RECOMMENDATION_CATEGORY_PERFORMANCE$
" +
	" RECOMMENDATION_CATEGORY_SECURITY'
" +
	"#RECOMMENDATION_CATEGORY_RELIABILITY*Ÿ
" +
	"RecommendationActionType*
" +
	"&RECOMMENDATION_ACTION_TYPE_UNSPECIFIED (
" +
	"$RECOMMENDATION_ACTION_TYPE_RIGHTSIZE(
" +
	"$RECOMMENDATION_ACTION_TYPE_TERMINATE2
" +
	".RECOMMENDATION_ACTION_TYPE_PURCHASE_COMMITMENT.
" +
	"*RECOMMENDATION_ACTION_TYPE_ADJUST_REQUESTS%
" +
	"!RECOMMENDATION_ACTION_TYPE_MODIFY,
" +
	"(RECOMMENDATION_ACTION_TYPE_DELETE_UNUSED&
" +
	"\"RECOMMENDATION_ACTION_TYPE_MIGRATE*
" +
	"&RECOMMENDATION_ACTION_TYPE_CONSOLIDATE'
" +
	"#RECOMMENDATION_ACTION_TYPE_SCHEDULE	'
" +
	"#RECOMMENDATION_ACTION_TYPE_REFACTOR
" +
	"$
" +
	" RECOMMENDATION_ACTION_TYPE_OTHER*Î
" +
...
" +
	" RECOMMENDATION_PRIORITY_CRITICAL*ß
" +
	"RecommendationSortBy&
" +
	"\"RECOMMENDATION_SORT_BY_UNSPECIFIED ,
" +
	"(RECOMMENDATION_SORT_BY_ESTIMATED_SAVINGS#
" +
	"RECOMMENDATION_SORT_BY_PRIORITY%
" +
	"!RECOMMENDATION_SORT_BY_CREATED_AT%
" +
	"!RECOMMENDATION_SORT_BY_CONFIDENCE*P
" +
	"	SortOrder
" +
...
" +
	"DismissalReason 
" +
	"DISMISSAL_REASON_UNSPECIFIED #
" +
	"DISMISSAL_REASON_NOT_APPLICABLE(
" +
	"$DISMISSAL_REASON_ALREADY_IMPLEMENTED(
" +
	"$DISMISSAL_REASON_BUSINESS_CONSTRAINT)
" +
	"%DISMISSAL_REASON_TECHNICAL_CONSTRAINT
" +
	"DISMISSAL_REASON_DEFERRED
" +
	"DISMISSAL_REASON_INACCURATE
" +
	"DISMISSAL_REASON_OTHER2ï
" +
	"CostSourceService?
" +
	"Name.pulumicost.v1.NameRequest.pulumicost.v1.NameResponseK
" +
	"Supports.pulumicost.v1.SupportsRequest.pulumicost.v1.SupportsResponseZ
" +
	"GetActualCost#.pulumicost.v1.GetActualCostRequest$.pulumicost.v1.GetActualCostResponsec
" +
	"GetProjectedCost&.pulumicost.v1.GetProjectedCostRequest'.pulumicost.v1.GetProjectedCostResponse]
" +
	"GetPricingSpec$.pulumicost.v1.GetPricingSpecRequest%.pulumicost.v1.GetPricingSpecResponseW
" +
	"EstimateCost\".pulumicost.v1.EstimateCostRequest#.pulumicost.v1.EstimateCostResponsei
" +
	"GetRecommendations(.pulumicost.v1.GetRecommendationsRequest).pulumicost.v1.GetRecommendationsResponser
" +
	"DismissRecommendation+.pulumicost.v1.DismissRecommendationRequest,.pulumicost.v1.DismissRecommendationResponseQ
" +
	"
" +
	"GetBudgets .pulumicost.v1.GetBudgetsRequest!.pulumicost.v1.GetBudgetsResponseZ
" +
	"GetPluginInfo#.pulumicost.v1.GetPluginInfoRequest$.pulumicost.v1.GetPluginInfoResponseE
" +
	"DryRun.pulumicost.v1.DryRunRequest.pulumicost.v1.DryRunResponse2¿
" +
	"ObservabilityServiceT
" +
	"HealthCheck!.pulumicost.v1.HealthCheckRequest\".pulumicost.v1.HealthCheckResponseQ
" +
	"
" +
	"GetMetrics .pulumicost.v1.GetMetricsRequest!.pulumicost.v1.GetMetricsResponse~
" +
	"GetServiceLevelIndicators/.pulumicost.v1.GetServiceLevelIndicatorsRequest0.pulumicost.v1.GetServiceLevelIndicatorsResponseBBZ@github.com/rshade/pulumicost-spec/sdk/go/proto/pulumicost/v1;pbcbproto3"
