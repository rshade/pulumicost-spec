...
const file_pulumicost_v1_registry_proto_rawDesc = "" +
	"
" +
	"pulumicost/v1/registry.protopulumicost.v1google/protobuf/timestamp.proto\"—
" +
	"DiscoverPluginsRequest8
" +
	"sources (2.pulumicost.v1.DiscoverySourceRsources
" +
	"filter (	Rfilter+
" +
	"include_installed (RincludeInstalled\"˜
" +
	"DiscoverPluginsResponse3
" +
	"plugins (2.pulumicost.v1.PluginInfoRpluginsH
" +
	"discovery_errors (2.pulumicost.v1.DiscoveryErrorRdiscoveryErrors\"‘
" +
	"
" +
	"PluginInfo
...
" +
	"author (	Rauthor6
" +
	"source (2.pulumicost.v1.DiscoverySourceRsource
" +
	"location (	Rlocation3
" +
	"status (2.pulumicost.v1.PluginStatusRstatusC
" +
	"security_level (2.pulumicost.v1.SecurityLevelRsecurityLevel\"
" +
	"capabilities	 (	RcapabilitiesE
" +
	"requirements
" +
	" (2!.pulumicost.v1.PluginRequirementsRrequirements#
" +
	"manifest_hash (	RmanifestHash=
" +
	"last_updated (2.google.protobuf.TimestampRlastUpdated\"Ø
" +
	"PluginRequirements(
" +
	"min_spec_version (	RminSpecVersion(
" +
	"max_spec_version (	RmaxSpecVersionC
" +
	"dependencies (2.pulumicost.v1.PluginDependencyRdependenciesR
" +
	"system_requirements (2!.pulumicost.v1.SystemRequirementsRsystemRequirementsU
" +
	"runtime_requirements (2\".pulumicost.v1.RuntimeRequirementsRruntimeRequirements\"q
" +
	"PluginDependency
" +
	"name (	Rname-
...
" +
	"SystemRequirements\"
" +
	"min_memory_mb (RminMemoryMb
" +
	"min_disk_mb (R	minDiskMb7
" +
	"supported_architectures (	RsupportedArchitectures!
" +
	"supported_os (	RsupportedOs\"§
" +
	"RuntimeRequirements!
" +
	"grpc_version (	RgrpcVersion!
" +
	"tls_required (RtlsRequired!
" +
	"auth_methods (	RauthMethods'
" +
	"timeout_seconds (RtimeoutSeconds\"œ
" +
...
" +
	"GetPluginManifestResponse9
" +
	"manifest (2.pulumicost.v1.PluginManifestRmanifest\"Ý
" +
	"PluginManifest9
" +
	"metadata (2.pulumicost.v1.PluginMetadataRmetadataH
" +
	"specification (2\".pulumicost.v1.PluginSpecificationRspecification9
" +
	"security (2.pulumicost.v1.PluginSecurityRsecurityC
" +
	"installation (2.pulumicost.v1.InstallationSpecRinstallationF
" +
	"configuration (2 .pulumicost.v1.ConfigurationSpecRconfiguration\"à
" +
	"PluginMetadata
" +
	"name (	Rname
...
" +
	"updated_at
" +
	" (2.google.protobuf.TimestampR	updatedAt\"Ž
" +
	"PluginSpecification!
" +
	"spec_version (	RspecVersion/
" +
	"supported_providers (	RsupportedProvidersk
" +
	"supported_resources (2:.pulumicost.v1.PluginSpecification.SupportedResourcesEntryRsupportedResources\"
" +
	"capabilities (	RcapabilitiesO
" +
	"service_definition (2 .pulumicost.v1.ServiceDefinitionRserviceDefinitionX
" +
	"observability_support (2#.pulumicost.v1.ObservabilitySupportRobservabilitySupportg
" +
	"SupportedResourcesEntry
" +
	"key (	Rkey6
" +
	"value (2 .pulumicost.v1.ProviderResourcesRvalue:8\"y
" +
	"ProviderResources%
" +
	"resource_types (	RresourceTypes#
" +
	"billing_modes (	RbillingModes
" +
	"regions (	Rregions\"³
" +
	"ServiceDefinition!
...
" +
	"port (Rport*
" +
	"health_check_path (	RhealthCheckPath\"æ
" +
	"ObservabilitySupport'
" +
	"metrics_enabled (RmetricsEnabled'
" +
	"tracing_enabled (RtracingEnabled'
" +
	"logging_enabled (RloggingEnabled2
" +
	"health_checks_enabled (RhealthChecksEnabled
" +
	"sli_support (R
" +
	"sliSupport\"Œ
...
" +
	"certificate_chain (	RcertificateChainC
" +
	"security_level (2.pulumicost.v1.SecurityLevelRsecurityLevel 
" +
	"permissions (	Rpermissions)
" +
	"sandbox_required (RsandboxRequired\"×
" +
	"InstallationSpecR
" +
	"installation_method (2!.pulumicost.v1.InstallationMethodRinstallationMethod!
" +
...
" +
	"install_script (	RinstallScript,
" +
	"pre_install_checks (	RpreInstallChecks,
" +
	"post_install_steps (	RpostInstallSteps\"¼
" +
	"ConfigurationSpec
" +
	"schema (	Rschema%
...
" +
	"examples (2#.pulumicost.v1.ConfigurationExampleRexamples\"d
" +
...
" +
	"config (	Rconfig\"½
" +
	"ValidatePluginRequest9
" +
	"manifest (2.pulumicost.v1.PluginManifestRmanifest-
" +
	"check_dependencies (RcheckDependencies:
" +
	"check_system_requirements (RcheckSystemRequirements\"¹
" +
	"ValidatePluginResponse
" +
	"valid (RvalidK
" +
	"validation_errors (2.pulumicost.v1.ValidationErrorRvalidationErrors<
" +
	"warnings (2 .pulumicost.v1.ValidationWarningRwarnings\"
" +
	"ValidationError
" +
	"code (	Rcode
...
" +
	"field (	Rfield8
" +
	"severity (2.pulumicost.v1.ErrorSeverityRseverity\"
" +
	"ValidationWarning
" +
	"code (	Rcode
...
" +
	"field (	Rfield&
" +
	"recommendation (	Rrecommendation\"è
" +
...
" +
	"location (	Rlocation#
" +
	"force_install (RforceInstall)
" +
	"verify_signature (RverifySignature\"Ô
" +
...
" +
	"install_path (	RinstallPathQ
" +
	"installation_errors (2 .pulumicost.v1.InstallationErrorRinstallationErrors\"w
" +
	"InstallationError
" +
	"code (	Rcode
...
" +
	"target_version (	RtargetVersion'
" +
	"allow_downgrade (RallowDowngrade%
" +
	"backup_current (RbackupCurrent\"ì
" +
...
" +
	"success (Rsuccess)
" +
	"previous_version (	RpreviousVersion'
" +
	"updated_version (	RupdatedVersion
" +
	"backup_path (	R
" +
	"backupPathE
" +
	"update_errors (2 .pulumicost.v1.InstallationErrorRupdateErrors\"o
" +
	"RemovePluginRequest
" +
	"name (	Rname!
" +
	"cleanup_data (RcleanupData!
" +
	"force_remove (RforceRemove\"Ç
" +
	"RemovePluginResponse
" +
	"success (Rsuccess'
" +
	"removed_version (	RremovedVersion#
" +
	"cleanup_paths (	RcleanupPathsG
" +
	"removal_errors (2 .pulumicost.v1.InstallationErrorRremovalErrors\"`
" +
	"ListInstalledPluginsRequest
" +
	"filter (	Rfilter)
" +
	"include_inactive (RincludeInactive\"S
" +
	"ListInstalledPluginsResponse3
" +
	"plugins (2.pulumicost.v1.PluginInfoRplugins\"W
" +
...
" +
	"health_errors (2.pulumicost.v1.HealthCheckErrorRhealthErrors\"˜
" +
	"HealthCheckError
" +
	"code (	Rcode
...
" +
	"DiscoverySource 
" +
	"DISCOVERY_SOURCE_UNSPECIFIED 
" +
	"DISCOVERY_SOURCE_FILESYSTEM
" +
	"DISCOVERY_SOURCE_REGISTRY
" +
	"DISCOVERY_SOURCE_URL
" +
	"DISCOVERY_SOURCE_GIT*Ò
" +
	"PluginStatus
" +
...
" +
	"PLUGIN_STATUS_INACTIVE
" +
	"PLUGIN_STATUS_ERROR
" +
	"PLUGIN_STATUS_UPDATING*¥
" +
	"SecurityLevel
" +
	"SECURITY_LEVEL_UNSPECIFIED 
" +
	"SECURITY_LEVEL_UNTRUSTED
" +
	"SECURITY_LEVEL_COMMUNITY
" +
	"SECURITY_LEVEL_VERIFIED
" +
	"SECURITY_LEVEL_OFFICIAL*½
" +
	"InstallationMethod#
" +
	"INSTALLATION_METHOD_UNSPECIFIED 
" +
	"INSTALLATION_METHOD_BINARY!
" +
	"INSTALLATION_METHOD_CONTAINER
" +
	"INSTALLATION_METHOD_SCRIPT
" +
	"INSTALLATION_METHOD_PACKAGE*›
" +
	"ErrorSeverity
" +
...
" +
	"DiscoverPlugins%.pulumicost.v1.DiscoverPluginsRequest&.pulumicost.v1.DiscoverPluginsResponsef
" +
	"GetPluginManifest'.pulumicost.v1.GetPluginManifestRequest(.pulumicost.v1.GetPluginManifestResponse]
" +
	"ValidatePlugin$.pulumicost.v1.ValidatePluginRequest%.pulumicost.v1.ValidatePluginResponseZ
" +
	"InstallPlugin#.pulumicost.v1.InstallPluginRequest$.pulumicost.v1.InstallPluginResponseW
" +
	"UpdatePlugin\".pulumicost.v1.UpdatePluginRequest#.pulumicost.v1.UpdatePluginResponseW
" +
	"RemovePlugin\".pulumicost.v1.RemovePluginRequest#.pulumicost.v1.RemovePluginResponseo
" +
	"ListInstalledPlugins*.pulumicost.v1.ListInstalledPluginsRequest+.pulumicost.v1.ListInstalledPluginsResponsef
" +
	"CheckPluginHealth'.pulumicost.v1.CheckPluginHealthRequest(.pulumicost.v1.CheckPluginHealthResponseBBZ@github.com/rshade/pulumicost-spec/sdk/go/proto/pulumicost/v1;pbcbproto3"
